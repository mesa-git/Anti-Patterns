NOTE:
The original page was here: [Wikipedia:Anti-Patterns](https://en.wikipedia.org/w/index.php?title=Anti-pattern)<br>
This was done because some "mod" on wikipedia decided _"first of all, "lists of examples" are not always encyclopedic; they are more a trash can."_, but as we know _"one man's trash is another man's treasure"_. So here's the trash can:
